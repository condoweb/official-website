        ...
        <div class="§fill-full" style="background:white;" >
            <div class="§fill-limits pad-40 §text-left">
                ...
                <div class="vistagriglia">
                    <div class="§grid gridSpace-10">
                        ...
                        <div class="columnContent desktop-25 mobile-33 compact-100">
                            <div class="§panel §text-center">
                                <a class="pad-4 §tooltip" title="Puoi scegliere di mantenere questa visualizzazione spuntandola tra le opzioni del tuo profilo"><i class="ico-eye"></i> stile tabulato</a>
                            </div>
                        </div>
                            ...
                            <div class="§panel §radius-medium">
                                ...
                                <div class="section-group">
                                    <div class="§button-group §radius-small-bottom §fill-full">
                                        <a class="§button §fill-full" style="display: block !important;" href="admin.gestionecondominio.php">Gestisci</a>
                                        <a class="§button §fill-full" style="display: block !important;" href="admin.modificacondominio.php">Modifica</a>
                                        <a class="§button §fill-full" style="display: block !important;">Elimina</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <hr/>
                    <a class="§button §fill-line"><i class="ico-home"></i> <b>crea nuovo condominio</b></a>
                </div>
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <th class="§text-left" width="100">
                                        <div class="§panel §text-center ">
                                            <a class="pad-4 §tooltip" title="Puoi scegliere di mantenere questa visualizzazione spuntandola tra le opzioni del tuo profilo"><i class="ico-eye"></i> visuale a box</a>
                                        </div>
                                    </th>
                                </tr>
                                <tr>
                                    ...
                                    <td width="100">
                                        <div class="§button-group §radius-small">
                                            <a class="§button" href="admin.gestionecondominio.php">Gestisci</a>
                                            <a class="§button" href="admin.modificacondominio.php">Modifica</a>
